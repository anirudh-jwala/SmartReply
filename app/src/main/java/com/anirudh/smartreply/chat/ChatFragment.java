package com.anirudh.smartreply.chat;
...
import com.anirudh.smartreply.R;
import com.anirudh.smartreply.model.Message;
...
public class ChatFragment extends Fragment implements ReplyChipAdapter.ClickListener{
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mSmartRepliesRecycler = view.findViewById(R.id.smartRepliesRecycler);
